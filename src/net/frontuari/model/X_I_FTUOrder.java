...
/** Generated Model for I_FTUOrder
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_I_FTUOrder extends PO implements I_I_FTUOrder, I_Persistent 
{
    ...
    public X_I_FTUOrder (Properties ctx, int I_FTUOrder_ID, String trxName)
    {
      super (ctx, I_FTUOrder_ID, trxName);
      /** if (I_FTUOrder_ID == 0)
        {
			setI_FTUOrder_ID (0);
    ...
    /** Load Constructor */
    public X_I_FTUOrder (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_FTUOrder[")
	...
	/** Set Import Order.
		@param I_FTUOrder_ID Import Order	  */
	public void setI_FTUOrder_ID (int I_FTUOrder_ID)
	{
		if (I_FTUOrder_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_FTUOrder_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_FTUOrder_ID, Integer.valueOf(I_FTUOrder_ID));
	}

	/** Get Import Order.
		@return Import Order	  */
	public int getI_FTUOrder_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_FTUOrder_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_FTUOrder_UU.
		@param I_FTUOrder_UU I_FTUOrder_UU	  */
	public void setI_FTUOrder_UU (String I_FTUOrder_UU)
	{
		set_Value (COLUMNNAME_I_FTUOrder_UU, I_FTUOrder_UU);
	}

	/** Get I_FTUOrder_UU.
		@return I_FTUOrder_UU	  */
	public String getI_FTUOrder_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_FTUOrder_UU);
	}
