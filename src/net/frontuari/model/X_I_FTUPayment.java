...
/** Generated Model for I_FTUPayment
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_I_FTUPayment extends PO implements I_I_FTUPayment, I_Persistent 
{
    ...
    public X_I_FTUPayment (Properties ctx, int I_FTUPayment_ID, String trxName)
    {
      super (ctx, I_FTUPayment_ID, trxName);
      /** if (I_FTUPayment_ID == 0)
        {
			setI_FTUPayment_ID (0);
			setI_IsImported (false);
        } */
    }

    /** Load Constructor */
    public X_I_FTUPayment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_FTUPayment[")
	...
	/** Set c_order_documentno.
		@param c_order_documentno c_order_documentno	  */
	public void setc_order_documentno (String c_order_documentno)
	{
		set_Value (COLUMNNAME_c_order_documentno, c_order_documentno);
	}

	/** Get c_order_documentno.
		@return c_order_documentno	  */
	public String getc_order_documentno () 
	{
		return (String)get_Value(COLUMNNAME_c_order_documentno);
	}
	...
	/** Set Import Payment.
		@param I_FTUPayment_ID Import Payment	  */
	public void setI_FTUPayment_ID (int I_FTUPayment_ID)
	{
		if (I_FTUPayment_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_FTUPayment_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_FTUPayment_ID, Integer.valueOf(I_FTUPayment_ID));
	}

	/** Get Import Payment.
		@return Import Payment	  */
	public int getI_FTUPayment_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_FTUPayment_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_FTUPayment_UU.
		@param I_FTUPayment_UU I_FTUPayment_UU	  */
	public void setI_FTUPayment_UU (String I_FTUPayment_UU)
	{
		set_Value (COLUMNNAME_I_FTUPayment_UU, I_FTUPayment_UU);
	}

	/** Get I_FTUPayment_UU.
		@return I_FTUPayment_UU	  */
	public String getI_FTUPayment_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_FTUPayment_UU);
	}
